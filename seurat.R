...
write.csv(zone2ExpressionDfGenesOfInterest, file = '/Users/madelinehakala/mouse-heart-scRNA-seq-analysis/zone2_expression_data_genes_of_interest')
...
write.csv(zone3ExpressionDfGenesOfInterest, file = '/Users/madelinehakala/mouse-heart-scRNA-seq-analysis/zone3_expression_data_genes_of_interest')
